...
namespace Sermo.UnitTests
{
    ...
    {
        [Test]
        public void ConstructingWithoutRoomRepositoryThrowsArgumentNullException() //Changes for Sprint 1 -- I want to create rooms for categorizing conversations -- Randi Lovelett
        {
